...
export function toOrderIntegrationRecord(
  ...
  return {
    ...
    shippingAddress: order.delivery_destination ? {
      postalCode: order.delivery_destination.postal_code,
      prefecture: order.delivery_destination.prefecture,
      city: order.delivery_destination.city,
      addressLine1: order.delivery_destination.address_line1,
      addressLine2: order.delivery_destination.address_line2,
      recipientName: order.delivery_destination.recipient_name,
      phone: order.delivery_destination.phone,
    } : null,
    status: order.status,
