      ...
      <div className="flex-1 flex flex-col min-w-0 pt-14 md:pt-0">
        <header className="bg-white border-b border-sky-100 px-4 sm:px-6 py-4 shadow-sm">
          ...
          <p className="text-slate-600 text-sm mt-0.5">
            {isClinicRole ? '患者様ポータルのホーム画面に表示するお知らせを管理できます' : 'BGJ職員向けの得意先ごとの編集はBGJポータルから行います'}
          </p>
        </header>
        ...
        <main className="flex-1 p-5 sm:p-6">
          ...
          {ready && !isClinicRole && (
            <Card theme="sky" className="p-5 sm:p-6 shadow-sm max-w-2xl">
              ...
              <p className="text-slate-500 text-sm mb-4">
                得意先ごとのお知らせの編集は、BGJポータルの「得意先一覧」から行えます。
              </p>
              <Link
                href="/bgj/customers"
          ...
          {ready && isClinicRole && (
            <Card theme="sky" className="p-5 sm:p-6 shadow-sm max-w-4xl">
              <ClinicAnnouncementManager theme="sky" />
            </Card>
          )}
        </main>
      </div>
