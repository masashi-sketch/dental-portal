...
const navItems: NavItem[] = [
  ...
  },
  {
    label: "担当者一覧",
    href: "/bgj/contacts",
    icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM5 21a7 7 0 0114 0M18 8h3m-1.5-1.5v3" /></svg>,
  },
  {
    label: "患者一覧",
    href: "/bgj/patients",
