        ...
        <div className="flex flex-col gap-5">
          ...
          <GuideCard audience="医院様へ" color="bg-teal-600">
            ...
            <Steps title="歯周病の診断結果を登録する">
              ...
              <li>登録した内容は、患者様ポータルの「お薬の受け取り」画面にすぐ反映されます。</li>
            </Steps>
            ...
            <Steps title="医院の表示名・背景画像を設定する">
              <li>サイドバーの「医院設定」を開きます（画面左に基本情報・取引条件、右に編集できる設定が並びます）。</li>
              <li>右側の「ブランディング設定」に、ポータルに表示したい名称や、患者様ポータルのログイン画面に使いたい背景画像のURLを入力し、「保存する」を押します。</li>
              <li>未入力のままにしておくと、標準の名称・背景画像がそのまま使われますので、必須ではありません。</li>
            </Steps>
            <Steps title="患者様ポータルのメニュー表示を選ぶ">
              <li>「医院設定」右側の「患者ポータルの表示設定」で、クリニック紹介・お薬の受け取り・定期購入・おすすめ商品・Q&amp;Aの表示/非表示をチェックボックスで選べます。</li>
              <li>チェックを外した項目は、患者様のメニューに表示されなくなります（「ホーム」は常に表示されます）。</li>
              <li>選び終えたら「保存する」を押してください。</li>
            </Steps>
            <div className="bg-slate-50 rounded-xl px-4 py-3 text-xs text-slate-500">
              ログインID・パスワードがご不明な場合や再発行をご希望の場合は、バイオガイア担当者までお問い合わせください。基本情報・取引条件（画面左側）の変更は、バイオガイア担当者までご連絡ください。
            </div>
          </GuideCard>
